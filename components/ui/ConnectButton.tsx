...
const AccountBlock = forwardRef((props: any, forwardedRef: any) => {
	...
	return <AnimatePresence mode={'wait'}>
		<motion.div className={cx('h-[50px] whitespace-nowrap min-w-[100px] cursor-pointer rounded-lg rounded-b-none px-4 flex flex-row items-center justify-start gap-4', {
			'bg-gray-800 animate-in w-[240px]': isOpen,
		})} {...props} ref={forwardedRef}>
			<BetLogo className={'border-yellow-400 border-2 w-8 h-8 rounded-full p-1 bg-primaryLighter'}/>
