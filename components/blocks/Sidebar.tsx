...
const Sidebar: FC<PropsWithChildren<{ links: NavItemProps[][] }>> = ({children, links}) => {
	...
	return <div className={cx('flex flex-col  px-5 min-h-[100vh]',
		minimized ? 'w-[70px]  border border-gray-800 bg-primaryLighter items-center justify-start ' : 'w-[250px] SIDEBAR items-start justify-start')}>
