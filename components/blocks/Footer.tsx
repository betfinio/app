		...
		<div className={'mb-10'}>
			<div className={'hidden px-10'}>
				...
				<p className={'mt-4 text-[#9BA9B4]'}>
					Betfin is decentralized web3 application that allows anyone to bet or stake through trustless contracts.
					This website is only an interface of the web3 application and
					runs as a non profit public service.
				</p>
				...
				<div className={'px-10 max-w-[1440px] mx-auto w-full'}>
					...
					<div className={'grid grid-cols-5'}>
						<div className={'col-span-5 md:col-span-1 xl:col-span-2 flex flex-col items-center md:items-baseline'}>
							...
							<div className={`
								...
								<a href={ETHSCAN + '/address/' + PARTNER}
								   target={'_blank'}
								   className={'text-white hover:text-[#FFC800] duration-300'}>{truncateEthAddress(PARTNER)}</a>
							</div>
						</div>
						<FooterMenu/>
					</div>
					...
					<div className={'py-6 border-b border-[#151A2A] mt-[30px] flex flex-col justify-between items-center font-semibold text-[#CFD4DD] gap-5 sm:flex-row'}>
						<div className={'flex flex-col items-center gap-5 sm:flex-row'}>
							...
							<div className={'flex gap-[10px] items-center'}>
								<a href={'https://twitter.com/betf1n1865/status/1787832131835613411'} target={"_blank"}
								...
								{/*	<Instagram/>*/}
								{/*</div>*/}
								<a href={'https://t.me/betfin_official'} target={'_blank'}
								   className="w-8 h-8 flex items-center justify-center rounded-full bg-[#25282C] text-white cursor-pointer hover:text-black hover:bg-[#FFC800] duration-300">
						...
						<div className={'flex flex-col items-center gap-5 sm:flex-row'}>
							...
							<div className={'flex gap-5 items-center'}>
								<a target={'_blank'} className={'-translate-y-[3px] hover:text-[#fc72ff] duration-300'}
								   href="https://app.uniswap.org/swap?outputCurrency=0xbF7970D56a150cD0b60BD08388A4A75a27777777">
									<Uniswap className={'text-inherit'}/>
								</a>
								<a target={'_blank'} className={'hover:text-yellow-400 duration-300'}
								   href="https://coinmarketcap.com/currencies/betfin/">
									<Coinmarketcap className={'text-inherit'}/>
								</a>
								<a target={'_blank'} className={'hover:text-[#4bcc00] duration-300'}
								   href="https://www.coingecko.com/en/coins/betfin-token">
					...
					<div className={'mt-[30px] flex items-center justify-between flex-wrap gap-7'}>
						<div
							...
							onClick={handleAdd}>Add <Bet className={'w-3 h-3'}/> token to Wallet
						</div>
						...
						<div className={'flex items-center justify-center gap-7 grow'}>
							<div
								className={'text-[#CFD4DD] hover:text-[#FFC800] group cursor-pointer duration-300 flex items-center gap-2'}>
								<p>Support</p>
								<Support/>
							</div>
...
export const FooterMenu = () => {
	return (
		<div className={'hidden mt-10 md:mt-0 lg:grid grid-cols-3 gap-10 sm:gap-0 col-span-5 md:col-span-4 xl:col-span-3'}>
			<div
				className={'flex flex-col items-center sm:items-baseline gap-1 md:pr-5 text-sm font-medium col-span-3 sm:col-span-1 justify-self-center md:justify-self-end'}>
				<p className={'text-[#D9E3EA] font-semibold'}>Betfin Games</p>
				<Link to={getGamesUrl('predict')} className={'cursor-pointer hover:text-[#FFC800] duration-300'}>Predict</Link>
				<Link to={getGamesUrl('roulette')} className={'cursor-pointer hover:text-[#FFC800] duration-300'}>Roulette</Link>
			</div>
			<div
				...
				<Link to={getStakingUrl('conservative')} className={'cursor-pointer hover:text-[#FFC800] duration-300'}>Conservative staking</Link>
				<Link to={getStakingUrl('dynamic')} className={'cursor-pointer hover:text-[#FFC800] duration-300'}>Dynamic staking</Link>
				<Link to={getAffiliateUrl('')} className={'cursor-pointer hover:text-[#FFC800] duration-300'}>Affiliate & binary matching</Link>
				<a href={'https://betfin.gitbook.io/betfin-public/v/for-partners'} target={'_blank'} className={'cursor-pointer hover:text-[#FFC800] duration-300'}>Become a partner</a>
			</div>
			<div
				className={'flex flex-col items-center sm:items-baseline gap-1 text-sm font-medium col-span-3 sm:col-span-1 justify-self-center md:justify-self-end'}>
				...
				<a href={"https://betfin.gitbook.io/betfin-public/v/about-betfin-1/betfin-governance/betfin-contract-addresses"} target={"_blank"}
				   className={'cursor-pointer hover:text-[#FFC800] duration-300'}>Official contracts</a>
				<a href={'https://betfin.gitbook.io/betfin-public/v/about-betfin-1/audits-and-bug-bounty/certik-audit'} target={'_blank'}
				   className={'cursor-pointer hover:text-[#FFC800] duration-300'}>Audits</a>
